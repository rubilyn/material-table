...
var MTableFilterRow = /*#__PURE__*/function (_React$Component) {
  ...
  function MTableFilterRow() {
    ...
    (0, _defineProperty2["default"])((0, _assertThisInitialized2["default"])(_this), "renderLookupFilter", function (columnDef) {
      return /*#__PURE__*/React.createElement(_core.FormControl, {
        style: {
          width: '100%'
        }
        ...
        input: /*#__PURE__*/React.createElement(_core.Input, {
    ...
    (0, _defineProperty2["default"])((0, _assertThisInitialized2["default"])(_this), "renderBooleanFilter", function (columnDef) {
      return /*#__PURE__*/React.createElement(_core.Checkbox, {
    ...
    (0, _defineProperty2["default"])((0, _assertThisInitialized2["default"])(_this), "renderDateTypeFilter", function (columnDef) {
      ...
      if (columnDef.type === 'date') {
        dateInputElement = /*#__PURE__*/React.createElement(_materialUiPickers.DatePicker, {
          value: columnDef.tableData.filterValue || null,
          onChange: onDateInputChange,
          clearable: true
        });
      } else if (columnDef.type === 'datetime') {
        dateInputElement = /*#__PURE__*/React.createElement(_materialUiPickers.DateTimePicker, {
          value: columnDef.tableData.filterValue || null,
          onChange: onDateInputChange,
          clearable: true
        });
      } else if (columnDef.type === 'time') {
        dateInputElement = /*#__PURE__*/React.createElement(_materialUiPickers.TimePicker, {
          value: columnDef.tableData.filterValue || null,
          onChange: onDateInputChange,
          clearable: true
        });
      ...
      return /*#__PURE__*/React.createElement(_materialUiPickers.MuiPickersUtilsProvider, {
  ...
  (0, _createClass2["default"])(MTableFilterRow, [{
    ...
    value: function render() {
      ...
      if (this.props.selection) {
        columns.splice(0, 0, /*#__PURE__*/React.createElement(_core.TableCell, {
          padding: "none",
      ...
      if (this.props.emptyCell && this.props.hasActions) {
        if (this.props.actionsColumnIndex === -1) {
          columns.push( /*#__PURE__*/React.createElement(_core.TableCell, {
          ...
          columns.splice(this.props.actionsColumnIndex + endPos, 0, /*#__PURE__*/React.createElement(_core.TableCell, {
            key: "key-action-column"
          }));
        }
      }
