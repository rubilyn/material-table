...
var MTableEditField = /*#__PURE__*/function (_React$Component) {
  ...
  (0, _createClass2["default"])(MTableEditField, [{
    ...
    value: function renderLookupField() {
      ...
      return /*#__PURE__*/React.createElement(_core.Select, (0, _extends2["default"])({}, this.getProps(), {
    ...
    value: function renderBooleanField() {
      ...
      return /*#__PURE__*/React.createElement(_core.Checkbox, (0, _extends2["default"])({}, this.getProps(), {
    ...
    value: function renderDateField() {
      ...
      }, /*#__PURE__*/React.createElement(_materialUiPickers.DatePicker, (0, _extends2["default"])({}, this.getProps(), {
        format: "dd.MM.yyyy",
    ...
    value: function renderTimeField() {
      return /*#__PURE__*/React.createElement(_materialUiPickers.MuiPickersUtilsProvider, {
        utils: _dateFns["default"]
      }, /*#__PURE__*/React.createElement(_materialUiPickers.TimePicker, (0, _extends2["default"])({}, this.getProps(), {
        format: "HH:mm:ss",
        value: this.props.value || null,
        onChange: this.props.onChange,
        clearable: true,
    ...
    value: function renderDateTimeField() {
      return /*#__PURE__*/React.createElement(_materialUiPickers.MuiPickersUtilsProvider, {
        utils: _dateFns["default"]
      }, /*#__PURE__*/React.createElement(_materialUiPickers.DateTimePicker, (0, _extends2["default"])({}, this.getProps(), {
    ...
    value: function renderTextField() {
      ...
      return /*#__PURE__*/React.createElement(_core.TextField, (0, _extends2["default"])({}, this.getProps(), {
