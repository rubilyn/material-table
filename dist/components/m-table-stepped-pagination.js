  ...
  (0, _createClass2["default"])(MTablePaginationInner, [{
    ...
    value: function renderPagesButton(start, end) {
      ...
      for (var p = start; p <= end; p++) {
        ...
        buttons.push( /*#__PURE__*/React.createElement(_core.Button, {
          size: "small",
          style: {
            boxShadow: 'none',
            maxWidth: '30px',
    ...
    value: function render() {
      ...
      }, /*#__PURE__*/React.createElement(this.props.icons.PreviousPage, null)))), /*#__PURE__*/React.createElement(_core.Hidden, {
        smDown: true
      }, this.renderPagesButton(pageStart, pageEnd)), /*#__PURE__*/React.createElement(_core.Tooltip, {
